<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
    <div class="container">
      <a class="navbar-brand" href="<?php echo base_url(); ?>"><b>Quora</b></a>
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item active">
            <a class="nav-link" href="<?php echo base_url(); ?>Answer_Controller/">Answer</a>
          </li>
		...
		<div class="modal-dialog">
		  ...
		  <div class="modal-content">
			...
			<div class="modal-body">
			  ...
			  echo "<input type='checkbox' name='HTML' value='HTML'>HTML<br>";
  ...
  $(document).ready(function(){
    ...
    {
      $.ajax({
        url:"<?php echo base_url(); ?>index.php/Scroll_pagination/fetch_questions",
        method:"POST",
	...
	function basicPopup(url) {
          popupWindow = window.open(url,'popUpWindow','height=500,width=1000,left=150px,top=150px,resizable=yes,scrollbars=yes,toolbar=yes,menubar=no,location=no,directories=no, status=yes')
	}
